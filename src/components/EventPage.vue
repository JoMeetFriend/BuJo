...
const fieldLabelClass =
  'field-label text-sm leading-none tracking-[0.01em] text-[#4A5040]'
const inputClass =
    ...
    <template #default>
      ...
      >
            ...
            <div
              ...
              @click.stop
            >
              <div class="grid grid-cols-[72px_1fr] max-sm:grid-cols-[56px_1fr] items-center gap-3 max-sm:gap-2">
