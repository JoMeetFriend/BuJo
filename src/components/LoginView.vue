...
<template>
  <div class="min-h-screen bg-page-bg bg-dot-pattern flex items-center justify-center p-6">
    <div class="bg-page-bg w-full max-w-[26.4rem] p-7 border-2 border-brand-text shadow-pixel hover:shadow-pixel-pressed hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-100">
