    ...
    <template #default>
      <div v-if="currentActivity" class="flex flex-col gap-5 select-none">
        ...
        <div class="flex gap-2 items-center h-12">
          <div
            class="h-12 w-12 flex items-center justify-center border border-[var(--bujo-line)] bg-[var(--bujo-surface-muted)]"
          >
            <svg class="h-6 w-6 text-[var(--bujo-ink)]" fill="currentColor" viewBox="0 0 24 24">
              <path
          ...
          <span
            class="inline-flex items-center justify-center py-0.5 text-xs font-bold border border-[var(--bujo-ink)] text-[var(--bujo-ink)] w-[76px] text-center whitespace-nowrap"
          ...
          <div class="flex items-center gap-1.5 h-6">
            <div class="flex items-center overflow-hidden">
              <img
                ...
                :key="participant.id"
                class="inline-block h-6 w-6 border border-[var(--bujo-line)] object-cover shrink-0 bg-[var(--bujo-surface-muted)]"
                :src="participant.avatar"
                alt="Avatar"
              />
              <span
                v-if="currentActivity?.currentCount > 5"
                class="flex items-center justify-center h-6 w-6 border border-[var(--bujo-line)] bg-[var(--bujo-surface)] text-[10px] font-bold text-[var(--bujo-ink)] shrink-0"
              >
...
const STATUS_MAP = {
  joined: { text: '已報名', badgeBg: 'bg-[var(--bujo-card-blue)]' },
  formed: { text: '已成團', badgeBg: 'bg-[var(--bujo-accent)]' },
  personal: { text: '個人行程', badgeBg: 'bg-[var(--bujo-surface)]' },
}
