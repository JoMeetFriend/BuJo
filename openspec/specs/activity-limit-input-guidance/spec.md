# activity-limit-input-guidance Specification

## Purpose

Define how the create-activity form explains that participant limits include the creator and prevents limited-capacity activities from being configured below two people.
