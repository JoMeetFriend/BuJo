# notification-hover-dismiss Specification

## Purpose

TBD - created by archiving change 'add-notification-hover-dismiss'. Update Purpose after archive.
...
<!-- @trace
source: add-notification-hover-dismiss
updated: 2026-07-16
code:
